...
#   codingUrl=git@e.coding.net:serverless-100008396491/link/link.git
# else
#   codingUrl=https://mMFjLAdigb:${CODING_TOKEN}@e.coding.net/serverless-100008396491/link/link.git
# fi
# git add -A
# git commit -m "${msg}"
